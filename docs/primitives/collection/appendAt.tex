...
\begin{argue}
  ...
  appendAt(X, \langle 0 \rangle, 5) = \langle \langle 0, 5 \rangle, x_{1}, x_{2} \rangle  & existing item gets 0 index \\
  appendAt(X, \langle 0, 0 \rangle, 5) = \langle \langle 5, 0 \rangle, x_{1}, x_{2} \rangle  & overwritting default behavior \\
