...
% FIXME: update this section to cover the 3 generic categories of functionality
% - replaceAt [done]
% - updateAt [TODO - distinguish from replaceAt]
% - appendAt [TODO - define new fn?_{nav}]

\subsection{Key Value Pairs}
Primitives which expect a Map $M = \ldata k_{i}v_{k_{i}}..k_{n}v_{k_{n}}..k_{j}v_{k_{j}} \rdata$
\subfile{primitives/kv/associateAt.tex}
% FIXME: refactor with walk
% associateAt = update in place, doesn't matter what was there
% TODO: accumulateAt = update in place using what was there (also uses walk)
...
% TODO: Reference another definition of atJsonPath and just provide examples
