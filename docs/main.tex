...
\item Example Algorithm
  \begin{enumerate}
  \item Init % WIP: - functionality in Z
  \item Relevant? % WIP: - functionality in Z
  \item Accept? % WIP: - functionality in Z
  \item Step % WIP: - functionality in Z
  \item Result % WIP: - functionality in Z
  \end{enumerate}
\end{enumerate}
...
% WIP - functionality in Z for each of the algorithm components
