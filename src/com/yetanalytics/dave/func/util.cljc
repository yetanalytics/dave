...
(comment
  ...
  (s/exercise-fn `timestamp->inst)

  (s/exercise-fn `inst->timestamp)





  (inst? (.toInstant (OffsetDateTime/parse "2013-05-18T05:32:34.804Z"
                                           iso)))

  (.toDate (.parse iso "2013-05-18T05:32:34.804+00:00"))


  (.format iso (java.util.Date.))
  (comment

    #?(:clj (def ^SimpleDateFormat iso
  ...
  #_(timestamp->inst "2018-01-01T00:00:00Z")

  (LocalDateTime/parse "2018-01-01T00:00:00")
  (.parse DateTimeFormatter/ISO_DATE_TIME "2018-01-01T00:00:00")
  )
